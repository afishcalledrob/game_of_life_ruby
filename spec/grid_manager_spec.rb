...
describe GridManager do
  ...
  it 'should respond to the attribute method "current_grid"' do
  ...
  it 'should respond to the attribute method "next_grid"' do
      expect(subject).to respond_to(:next_grid)
  end
  
 it 'should respond to the method "update" by generating a next_grid' do
     subject.start(10, 10) 
     subject.update
     expect(next_grid).to have_received(:generate)
